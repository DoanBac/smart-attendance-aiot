...
class Settings(BaseSettings):
    ...
    # CNN anti-spoof / liveness model
    ANTISPOOF_MODEL_PATH: str = "/app/antispoof/anti-spoof-mn3.onnx"
    ANTISPOOF_MODEL_TYPE: str = "openvino_mn3"   # openvino_mn3 | custom_cnn
    ANTISPOOF_INPUT_SIZE: int = 128
    ANTISPOOF_THRESHOLD: float = 0.42
